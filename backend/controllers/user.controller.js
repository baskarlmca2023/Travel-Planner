...
//       return res.status(401).send({
//         success: false,
//         message: "You can only update your own account profile photo please login again!",
//       });
//     }

//     let avatar = req.body.avatar;

//     // Handle base64 image if it's passed
//     if (avatar && avatar.startsWith('data:image')) {
//       // If avatar is base64 string, save as a file or store it as a string
//       // This example assumes you're storing the base64 directly in the database.
//     }
