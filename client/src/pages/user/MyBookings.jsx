...
//     doc.setFontSize(18);
//     doc.setFont("bold");
//     doc.text("Travels & Tourism", pageWidth / 2, 50, { align: "center" });
//     doc.text("Receipt", pageWidth / 2, 60, { align: "center" });

//     // Customer Details
//     doc.setFontSize(12);
//     doc.setFont("normal");
//     doc.text(`Customer Name: ${currentUser.username}`, 10, 70);
//     doc.text(`Email: ${currentUser.email}`, 10, 80);
//     doc.text(`Phone: ${currentUser.phone}`, 10, 90);
//     doc.text(`Address: ${currentUser.address}`, 10, 100);
//     doc.text(`Destination: ${booking?.packageDetails?.packageDestination}`, 10, 110);
//     doc.text(`Date: ${booking?.date}`, 10, 120);
//     doc.text(`Persons: ${booking?.persons}`, 10, 130);
...
//     // Cost Breakdown
//     doc.setFontSize(12);
//     doc.text("Cost Breakdown:", 10, 140);
//     doc.text("-------------------------------------------------", 10, 145);
//     doc.text(`• Gourmet Meals & Refreshments (5%): ₹${foodCharge.toFixed(2)}`, 10, 155);
//     doc.text(`• Luxury Hotel Accommodation (20%): ₹${luxuryHotelCharge.toFixed(2)}`, 10, 165);
//     doc.text(`• Sightseeing & Guided Tours (30%): ₹${touristCharge.toFixed(2)}`, 10, 175);
//     doc.text(`• Local Transportation Services (10%): ₹${localTransportCharge.toFixed(2)}`, 10, 185);
//     doc.text(`• Premium Air Travel (35%): ₹${airTransportCharge.toFixed(2)}`, 10, 195);
//     doc.text("-------------------------------------------------", 10, 205);
    
//     doc.setFont("bold");
//     doc.text(`Total Amount Payable: ₹${totalPrice.toFixed(2)}`, 10, 215);
//     doc.setFontSize(10);
//     doc.text(
...
//pages/user/MyBookins.jsx
import React, { useEffect, useState } from "react";
import { useSelector } from "react-redux";
import { Link } from "react-router-dom";
import { jsPDF } from "jspdf";
import logoImg from "../assets/images/baskar.png"; // Update path as needed
