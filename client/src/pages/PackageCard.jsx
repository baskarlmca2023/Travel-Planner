...
//       <div className="w-full bg-white border flex flex-col items-center p-3 rounded shadow-md overflow-hidden">
//         {/* Image Carousel */}
//         <div className="w-full h-[220px] rounded border overflow-hidden">
//           <Slider {...settings}>
//             {packageData.packageImages.map((image, index) => (
//               <div key={index}>
//                 <img className="w-full h-[220px] object-cover" src={image} alt={`Package ${index + 1}`} />
//               </div>
//             ))}
//           </Slider>
//         </div>
