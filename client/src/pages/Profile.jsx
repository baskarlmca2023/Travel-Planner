...
//         // If the photo is a file, append it as FormData
//         formData.append("avatar", photo);
//       } else if (photo) {
//         // If the photo is base64, send it as JSON
//         formData.append("avatar", photo);
//       }
...
//       if (data?.success) {
//         alert(data?.message);
//         setFormData({ ...formData, avatar: data?.user.avatar }); // Update avatar URL
//         dispatch(updateUserSuccess(data?.user));
...
//     } catch (error) {
//       console.log(error);
//       dispatch(updateUserFailure("Failed to upload profile photo"));
//     }
//   };
...
//     if (file) {
//       // Convert file to base64 if necessary or directly pass the file
//       convertToBase64(file)
//         .then((base64) => {
//           setProfilePhoto(base64);  // Save the base64 string if required
//         })
