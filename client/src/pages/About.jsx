...
//           <h1 className="text-xl font-semibold text-center">Baskar LI</h1>
//         </div>
...
//             alt="Profile"
//           />
//           <h2 className="text-2xl font-semibold text-gray-800 mt-4">Baskar LI</h2>
...
//             href="https://github.com/baskarlmca2023"
//             target="_blank"
...
//           <a
//             className="flex items-center gap-2 text-white bg-blue-900 hover:bg-blue-950 px-4 py-2 rounded-lg shadow-md transition duration-300"
//             href="https://www.linkedin.com/in/baskar-l-421871268/"
//             target="_blank"
//             rel="noopener noreferrer"
//           >
//             LinkedIn <FaExternalLinkAlt />
...
import travelImg from "../assets/images/baskar.png";
import { FaExternalLinkAlt } from "react-icons/fa";
    ...
    <div className="w-full flex justify-center py-12 bg-gradient-to-b from-gray-50 to-gray-200">
      <div className="w-[90%] max-w-3xl bg-white rounded-2xl shadow-2xl p-8 flex flex-col items-center gap-6 transition-transform transform hover:scale-105">
        ...
        <div className="flex flex-col items-center text-center">
          ...
          />
          <h1 className="text-4xl font-extrabold text-gray-800 tracking-wide"> 🌍Travels & Tourism ✈️ </h1>
          <h2 className="text-2xl font-semibold text-gray-800 mt-4">Your Ultimate Travel Companion 🏕️</h2>
          <p className="text-lg text-gray-600">Plan, explore, and create unforgettable experiences 🌟</p>
        </div>
        <p className="text-center text-gray-700 leading-relaxed px-6 text-lg">
          Travel Planner ✨ simplifies your journey with seamless itinerary planning, expense tracking, and destination discovery—all in one place. Whether it's a solo adventure 🧳 or a family getaway 🏖️, we make every trip effortless and memorable.
        </p>
        <div className="flex gap-6 text-lg">
          <a
            className="flex items-center gap-2 text-white bg-blue-900 hover:bg-blue-950 px-4 py-2 rounded-lg shadow-md transition duration-300"
...
export default About;
 ...
 {/* <a
            className="flex items-center gap-2 text-white bg-blue-900 hover:bg-blue-950 px-4 py-2 rounded-lg shadow-md transition duration-300"
            href="https://www.travelplannerapp.com"
            target="_blank"
            rel="noopener noreferrer"
          >
